...
from medico.models import DadosMedico, Documento, Especialidades, DatasAbertas, is_medico
...
def minhas_consultas(request):
    # Fazer filtro dos médicos e das especialidaes em minhas consultas(tema)
